...
class MaintainerContactFinder
{
    ...
    private static function constraintsOverlap(string $constraint1, string $constraint2): bool
    {
        ...
        if ((str_starts_with($constraint1, '^') || str_starts_with($constraint1, '~'))
            && (str_starts_with($constraint2, '^') || str_starts_with($constraint2, '~'))) {
            ...
            if (count($parts1) > 0 && count($parts2) > 0) {
                ...
                if (str_starts_with($constraint1, '^') && str_starts_with($constraint2, '^')) {
